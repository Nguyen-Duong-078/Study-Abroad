...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact " dir="ltr"
    data-theme="theme-bordered" data-assets-path="{{ asset('assets') }}/admin/"
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('assets') }}/admin/img/logo/logo.png" />
    ...
    <link rel="stylesheet" href="{{ asset('assets') }}/admin/vendor/css/rtl/theme-bordered.css"
